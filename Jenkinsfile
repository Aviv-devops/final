        ...
        stage("Connect To ECR") {
            steps{
                sshagent(credentials:['devops']) {
                    ...
                    sh 'ssh -T -o StrictHostKeyChecking=no ubuntu@34.201.220.235 "docker login -u AWS -p $(aws ecr get-login-password --region us-east-1) 808447716657.dkr.ecr.us-east-1.amazonaws.com"'
